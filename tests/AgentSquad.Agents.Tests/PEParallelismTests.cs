...
/// </summary>
public class PEParallelismTests
{
    // ── Path Normalization ──────────────────────────────────────────────
    ...
    {
        Assert.Equal(expected, PrincipalEngineerAgent.NormalizeFilePath(input));
    }
    ...
    public void ExtractAllFilesFromFilePlan_ExtractsCreateAndModify()
    {
        ...
        var files = PrincipalEngineerAgent.ExtractAllFilesFromFilePlan(filePlan);
    ...
    {
        Assert.Empty(PrincipalEngineerAgent.ExtractAllFilesFromFilePlan(""));
        Assert.Empty(PrincipalEngineerAgent.ExtractAllFilesFromFilePlan(null!));
    }
    ...
    public void ExtractSharedFilesFromFilePlan_ExtractsSharedDeclarations()
    {
        ...
        var shared = PrincipalEngineerAgent.ExtractSharedFilesFromFilePlan(filePlan);
    ...
    {
        Assert.Empty(PrincipalEngineerAgent.ExtractSharedFilesFromFilePlan(""));
    }
    ...
    public void DetectFileOverlaps_NoOverlaps_ReturnsEmpty()
    {
        ...
        var overlaps = PrincipalEngineerAgent.DetectFileOverlaps(tasks, []);
    ...
    public void DetectFileOverlaps_SharedFilesExcluded()
    {
        ...
        var overlaps = PrincipalEngineerAgent.DetectFileOverlaps(tasks, shared);
        Assert.Empty(overlaps);
    }
    ...
    public void ParseTypedDependencies_TypedFormat_ParsesCorrectly()
    {
        ...
        var (plainDeps, depTypes) = PrincipalEngineerAgent.ParseTypedDependencies(rawDeps);
    ...
    public void CanRelaxDependency_ApiDep_W1Task_CanRelax()
    {
        ...
        Assert.True(PrincipalEngineerAgent.CanRelaxDependency("api", depTask, []));
    }
    ...
    {
        var depTask = new EngineeringTask { Id = "T2", Wave = "W1" };
        Assert.False(PrincipalEngineerAgent.CanRelaxDependency("files", depTask, []));
    }
    ...
    public void CanRelaxDependency_SchemaDep_OnlyT1CanRelax()
    {
        ...
        Assert.True(PrincipalEngineerAgent.CanRelaxDependency("schema", t1, []));
        Assert.False(PrincipalEngineerAgent.CanRelaxDependency("schema", t2, []));
    }
    ...
    {
        var depTask = new EngineeringTask { Id = "T2", Wave = "W1" };
        Assert.False(PrincipalEngineerAgent.CanRelaxDependency("unknown", depTask, []));
    }
